...
first_weapon = current_weapon; first_w_mods = [Equipment.ricochet_ammo];
second_weapon = variable_clone(Equipment.pistol); second_w_mods = [Equipment.suppressor, Equipment.ricochet_ammo];
